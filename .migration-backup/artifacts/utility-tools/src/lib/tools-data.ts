...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-business-name', name: 'AI Business Name Generator', description: 'Generate creative, memorable business names for your industry.', category: 'ai', keywords: ['ai', 'business name', 'branding', 'startup'], new: true, icon: 'Building2' },
  { slug: 'ai-slogan-generator', name: 'AI Slogan Generator', description: 'Create catchy, memorable slogans and taglines for your brand or business.', category: 'ai', keywords: ['ai', 'slogan', 'tagline', 'brand', 'marketing'], new: true, icon: 'Megaphone' },
  { slug: 'ai-product-description', name: 'AI Product Description Generator', description: 'Write compelling product descriptions that convert for e-commerce and listings.', category: 'ai', keywords: ['ai', 'product description', 'ecommerce', 'marketing'], new: true, icon: 'ShoppingBag' },
