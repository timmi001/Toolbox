...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-study-notes', name: 'AI Study Notes Generator', description: 'Turn any topic into structured, easy-to-review study notes and summaries.', category: 'ai', keywords: ['ai', 'study notes', 'education', 'learning'], new: true, icon: 'NotebookPen' },
  { slug: 'ai-quiz-generator', name: 'AI Quiz Generator', description: 'Generate quiz questions with multiple choice answers on any topic or difficulty.', category: 'ai', keywords: ['ai', 'quiz', 'questions', 'education', 'test'], new: true, icon: 'HelpCircle' },
