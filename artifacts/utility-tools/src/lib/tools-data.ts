...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-price-comparison', name: 'AI Price Comparison', description: 'Compare ticket prices, seating options, fees, and value across multiple event sources.', category: 'ai-events', keywords: ['ai', 'price comparison', 'ticket prices', 'value'], new: true, icon: 'CircleDollarSign' },
  { slug: 'ai-price-tracker', name: 'AI Price Tracker', description: 'Track price changes, spot deals, and get a simple buying strategy for your chosen event.', category: 'ai-events', keywords: ['ai', 'price tracker', 'ticket deals', 'alerts'], new: true, icon: 'TrendingDown' },
  { slug: 'ai-ticket-alerts', name: 'AI Ticket Alerts', description: 'Create smart alerts and reminders for new inventory, price drops, and release windows.', category: 'ai-events', keywords: ['ai', 'ticket alerts', 'reminders', 'price drops'], new: true, icon: 'BellRing' },
