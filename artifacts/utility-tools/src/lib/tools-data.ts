...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-homework-helper', name: 'Homework Helper', description: 'Break down assignments into clear steps, examples, and study guidance.', category: 'ai', keywords: ['homework', 'study', 'assignment', 'education'], new: true, icon: 'BookOpen' },
  { slug: 'ai-essay-writer', name: 'Essay Writer', description: 'Draft structured essays with clear introductions, arguments, and conclusions.', category: 'ai', keywords: ['essay', 'writing', 'school', 'education'], new: true, icon: 'PenSquare' },
  { slug: 'ai-essay-improver', name: 'Essay Improver', description: 'Refine essays for clarity, structure, and stronger academic writing.', category: 'ai', keywords: ['essay', 'improve', 'writing', 'school'], new: true, icon: 'Sparkles' },
  { slug: 'ai-essay-generator', name: 'Essay Generator', description: 'Generate polished essay drafts from a topic, tone, and length preference.', category: 'ai', keywords: ['essay', 'generator', 'academic', 'writing'], new: true, icon: 'FileText' },
  { slug: 'ai-paraphrasing-tool', name: 'Paraphrasing Tool', description: 'Rewrite academic or creative text while preserving the original meaning.', category: 'ai', keywords: ['paraphrase', 'rewrite', 'study', 'writing'], new: true, icon: 'Repeat2' },
  { slug: 'ai-math-solver', name: 'Math Solver', description: 'Solve simple math problems step by step with clear explanations.', category: 'ai', keywords: ['math', 'solver', 'equation', 'study'], new: true, icon: 'Calculator' },
  { slug: 'ai-study-planner', name: 'Study Planner', description: 'Build a practical study schedule for exams, assignments, and revision goals.', category: 'ai', keywords: ['study', 'planner', 'schedule', 'exam'], new: true, icon: 'CalendarDays' },
  { slug: 'ai-jamb-cbt-practice', name: 'JAMB CBT Practice', description: 'Create realistic JAMB-style practice questions for exam preparation.', category: 'ai', keywords: ['jamb', 'exam', 'practice', 'cbt'], new: true, icon: 'ClipboardList' },
  { slug: 'ai-jamb-subject-combination', name: 'JAMB Subject Combination', description: 'Recommend subject combinations for common university and course goals.', category: 'ai', keywords: ['jamb', 'subject combination', 'admission', 'course'], new: true, icon: 'BookOpen' },
  { slug: 'ai-jamb-cutoff-checker', name: 'JAMB Cutoff Checker', description: 'Estimate whether a score range is likely to meet a target cutoff.', category: 'ai', keywords: ['jamb', 'cutoff', 'score', 'admission'], new: true, icon: 'TrendingUp' },
  { slug: 'ai-ghostwriting', name: 'Ghostwriting Assistant', description: 'Create polished draft content for articles, speeches, and personal writing projects.', category: 'ai', keywords: ['ghostwriting', 'writing', 'draft', 'content'], new: true, icon: 'PenLine' },
  { slug: 'ai-story-writer', name: 'Story Writer', description: 'Generate short creative story prompts and story drafts with a chosen tone.', category: 'ai', keywords: ['story', 'creative writing', 'fiction', 'prompt'], new: true, icon: 'BookText' },
  { slug: 'ai-book-outline-generator', name: 'Book Outline Generator', description: 'Create a simple book structure with chapters and major sections.', category: 'ai', keywords: ['book', 'outline', 'writing', 'chapter'], new: true, icon: 'NotebookPen' },
  { slug: 'ai-chapter-generator', name: 'Chapter Generator', description: 'Draft a chapter introduction or section for a book or long-form piece.', category: 'ai', keywords: ['chapter', 'writing', 'book', 'draft'], new: true, icon: 'FilePlus' },
  { slug: 'ai-speech-writer', name: 'Speech Writer', description: 'Draft speeches for school, business, or personal presentations.', category: 'ai', keywords: ['speech', 'presentation', 'writing', 'talk'], new: true, icon: 'Mic' },
