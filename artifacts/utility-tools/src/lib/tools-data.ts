...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-code-explainer', name: 'AI Code Explainer', description: 'Understand any code snippet with clear, plain-English explanations.', category: 'ai', keywords: ['ai', 'code', 'explain', 'developer', 'programming'], new: true, icon: 'BookOpen' },
  { slug: 'ai-code-reviewer', name: 'AI Code Reviewer', description: 'Get professional code review feedback with suggestions for improvement.', category: 'ai', keywords: ['ai', 'code review', 'quality', 'developer', 'feedback'], new: true, icon: 'GitPullRequestArrow' },
  { slug: 'ai-bug-finder', name: 'AI Bug Finder', description: 'Automatically detect bugs, errors, and vulnerabilities in your code.', category: 'ai', keywords: ['ai', 'bug', 'debug', 'error', 'developer'], new: true, icon: 'Bug' },
  { slug: 'ai-json-formatter', name: 'AI JSON Formatter & Explainer', description: 'Format, validate, and get AI-powered explanations of JSON structure and data.', category: 'ai', keywords: ['ai', 'json', 'format', 'explain', 'developer'], new: true, icon: 'Braces' },
