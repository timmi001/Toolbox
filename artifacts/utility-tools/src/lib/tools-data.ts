...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-jamb-subject-combination', name: 'JAMB Subject Combination', description: 'Recommend subject combinations for common university and course goals.', category: 'ai-study-exams', keywords: ['jamb', 'subject combination', 'admission', 'course'], new: true, icon: 'BookOpen' },
  { slug: 'ai-jamb-cutoff-checker', name: 'JAMB Cutoff Checker', description: 'Estimate whether a score range is likely to meet a target cutoff.', category: 'ai-study-exams', keywords: ['jamb', 'cutoff', 'score', 'admission'], new: true, icon: 'TrendingUp' },
