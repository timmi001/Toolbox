...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-ad-copy-generator', name: 'AI Ad Copy Generator', description: 'Create high-impact ad copy for paid campaigns, launches, and product promotions.', category: 'ai', keywords: ['ai', 'ad copy', 'marketing', 'advertising', 'campaign'], new: true, icon: 'Megaphone' },
  { slug: 'ai-facebook-ad-copy-generator', name: 'AI Facebook Ad Copy Generator', description: 'Write persuasive Facebook ad copy tailored to your audience and objective.', category: 'ai', keywords: ['ai', 'facebook ads', 'social media', 'marketing', 'copy'], new: true, icon: 'BadgeCheck' },
  { slug: 'ai-google-ads-copy-generator', name: 'AI Google Ads Copy Generator', description: 'Generate concise, conversion-focused Google Ads copy for search and display campaigns.', category: 'ai', keywords: ['ai', 'google ads', 'ppc', 'marketing', 'copy'], new: true, icon: 'Search' },
  { slug: 'ai-linkedin-ad-copy-generator', name: 'AI LinkedIn Ad Copy Generator', description: 'Craft professional LinkedIn ad copy for B2B campaigns and lead generation.', category: 'ai', keywords: ['ai', 'linkedin ads', 'b2b', 'marketing', 'copy'], new: true, icon: 'Briefcase' },
  { slug: 'ai-sales-copy-generator', name: 'AI Sales Copy Generator', description: 'Write persuasive sales copy for emails, landing pages, and product offers.', category: 'ai', keywords: ['ai', 'sales copy', 'conversion', 'marketing', 'copywriting'], new: true, icon: 'TrendingUp' },
  { slug: 'ai-landing-page-copy-generator', name: 'AI Landing Page Copy Generator', description: 'Generate conversion-focused landing page sections, headlines, and benefits.', category: 'ai', keywords: ['ai', 'landing page', 'copywriting', 'marketing', 'conversion'], new: true, icon: 'LayoutPanelTop' },
  { slug: 'ai-cta-generator', name: 'AI CTA Generator', description: 'Generate clear, compelling call-to-action text for ads, emails, and landing pages.', category: 'ai', keywords: ['ai', 'cta', 'call to action', 'conversion', 'marketing'], new: true, icon: 'MousePointerSquare' },
