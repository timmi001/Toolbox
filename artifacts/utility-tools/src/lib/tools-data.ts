export type ToolCategory = 'text' | 'developer' | 'image' | 'pdf' | 'calculators' | 'file-conversion' | 'business' | 'ai' | 'marketing' | 'audio' | 'video' | 'ai-resume' | 'ai-social' | 'ai-blogging-seo' | 'ai-email' | 'ai-grammar' | 'ai-study-exams' | 'ai-ghostwriting' | 'ai-events' | 'ai-study';
...
export const toolsData: Tool[] = [
  ...
  { slug: 'ai-jamb-cbt-practice', name: 'JAMB CBT Practice', description: 'Create realistic JAMB-style practice questions for exam preparation.', category: 'ai-study-exams', keywords: ['jamb', 'exam', 'practice', 'cbt'], new: true, icon: 'ClipboardList' },
  { slug: 'ai-jamb-cutoff-checker', name: 'JAMB Cut-off Checker', description: 'Check JAMB cut-off marks for universities and courses to see if your score qualifies.', category: 'ai-study-exams', keywords: ['jamb', 'cutoff', 'university', 'score', 'admission'], new: true, icon: 'BadgeCheck' },
  { slug: 'ai-jamb-subject-combination', name: 'JAMB Subject Combination Finder', description: 'Find the correct JAMB subject combination required for any course and university.', category: 'ai-study-exams', keywords: ['jamb', 'subject combination', 'course', 'waec', 'university'], new: true, icon: 'BookMarked' },
  { slug: 'ai-notes-summarizer', name: 'AI Notes Summarizer', description: 'Turn lecture or class notes into a structured revision summary with key points and likely exam questions.', category: 'ai-study-exams', keywords: ['notes', 'summarize', 'study', 'revision', 'lecture'], new: true, icon: 'NotebookText' },
  { slug: 'waec-past-questions', name: 'WAEC Past Questions', description: 'Generate WAEC-style practice exam questions with model answers for any subject.', category: 'ai-study-exams', keywords: ['waec', 'past questions', 'practice', 'exam', 'nigeria'], new: true, icon: 'FileQuestion' },
  // AI Study, Exam, and Event Planning Tools
  ...
  { slug: 'gpa-calculator', name: 'GPA/CGPA Calculator', description: 'Calculate your semester GPA and cumulative CGPA with 4.0 or 5.0 scale support.', category: 'ai-study-exams', keywords: ['gpa', 'cgpa', 'grades', 'calculator', 'school'], icon: 'GraduationCap' },
