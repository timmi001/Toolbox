...
const CATEGORIES = [
  ...
  { id: 'ai-ghostwriting', name: 'AI Ghostwriting Tools', icon: PenLine, path: '/ai-ghostwriting-tools', desc: 'Create polished stories, book outlines, chapters, speeches, scripts, and newsletters.', accent: 'from-purple-500/15 via-violet-500/10 to-transparent' },
  { id: 'ai-study', name: 'AI Study Workspace', icon: GraduationCap, path: '/ai-study-tools', desc: 'Practice questions, mock exams, tutor chats, performance reviews, and daily revision plans.', accent: 'from-cyan-500/15 via-sky-500/10 to-transparent' },
  { id: 'ai-events', name: 'AI Event Planning', icon: Sparkles, path: '/ai-event-tools', desc: 'Plan itineraries, invitations, checklists, tickets, trips, and local events with AI.', accent: 'from-orange-500/15 via-amber-500/10 to-transparent' },
