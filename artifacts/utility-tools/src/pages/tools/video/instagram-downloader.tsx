...
const config: PlatformConfig = {
  ...
  urlHint: 'Works with Instagram Reels, Videos, and IGTV links.',
  exampleUrl: 'https://www.instagram.com/reel/AbCdEfGhIjK/',
};

export default function InstagramDownloader() {
  const tool = getToolBySlug('instagram-downloader')!;
