      ...
      {valid && (
        <div className="grid md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-muted/20 rounded-xl border border-border/30">
            ...
            <div className="text-2xl font-bold line-through text-muted-foreground">${orig.toFixed(2)}</div>
          </div>
          <div className="text-center p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
            <div className="text-sm text-green-400 mb-1">You Save</div>
            <div className="text-2xl font-bold text-green-400">${saved.toFixed(2)}</div>
          </div>
          <div className="text-center p-4 bg-primary/10 border border-primary/30 rounded-xl">
            ...
            <div className="text-2xl font-bold text-primary">${final.toFixed(2)}</div>
          </div>
        </div>
      )}
    </ToolLayout>
