...
const AiScriptWriter = L(() => import("@/pages/tools/ai/ai-script-writer"));
const AiNewsletterWriter = L(() => import("@/pages/tools/ai/ai-newsletter-writer"));
const AiBiographyGenerator = L(() => import("@/pages/tools/ai/ai-biography-generator"));
const AiPersonalStatementWriter = L(() => import("@/pages/tools/ai/ai-personal-statement-writer"));
const AiLetterWriter = L(() => import("@/pages/tools/ai/ai-letter-writer"));
...
const AiNotesSummarizer = L(() => import("@/pages/tools/ai/ai-notes-summarizer"));
const WaecPastQuestions = L(() => import("@/pages/tools/ai/waec-past-questions"));
const AiGhostwriting = L(() => import("@/pages/tools/ai/ai-ghostwriting"));

function GenericAiToolRoute() {
  const [, params] = useRoute("/tools/ai/:slug");
  const tool = params?.slug ? getToolBySlug(params.slug) : undefined;
  return tool ? <AiToolShell tool={tool} /> : <NotFound />;
}
  ...
  return (
    <CurrencyPreferenceProvider>
      <Layout>
        ...
        <Route path="/ai-study-tools" component={CategoryPage} />
        ...
        <Route path="/tools/ai/ai-script-writer" component={AiScriptWriter} />
        <Route path="/tools/ai/ai-newsletter-writer" component={AiNewsletterWriter} />
        <Route path="/tools/ai/ai-biography-generator" component={AiBiographyGenerator} />
        <Route path="/tools/ai/ai-personal-statement-writer" component={AiPersonalStatementWriter} />
        <Route path="/tools/ai/ai-letter-writer" component={AiLetterWriter} />
        ...
        <Route path="/tools/ai/ai-notes-summarizer" component={AiNotesSummarizer} />
        <Route path="/tools/ai/waec-past-questions" component={WaecPastQuestions} />
        <Route path="/tools/ai/gpa-calculator" component={GpaCalculator} />
        <Route path="/tools/ai/ai-ghostwriting" component={AiGhostwriting} />
        <Route path="/tools/ai/:slug" component={GenericAiToolRoute} />
        <Route path="/tools/ai/ai-story-writer" component={AiStoryWriter} />
        <Route path="/tools/ai/ai-book-outline-generator" component={AiBookOutlineGenerator} />
        <Route path="/tools/ai/ai-chapter-generator" component={AiChapterGenerator} />
        <Route path="/tools/ai/ai-speech-writer" component={AiSpeechWriter} />
